...
import com.conglai.uikit.feature.abs.callback.AbsCallBackLinearLayout;
 ...
 */
public class AbsJudgeLinearLayout extends AbsCallBackLinearLayout {

    public AbsJudgeLinearLayout(Context context) {
        super(context);
    }

    public AbsJudgeLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AbsJudgeLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
